        ...
        <section id='home' > 
            ...
            >
                ...
                <Stack direction={'column'} spacing={2} sx={{ alignItems: { lg: 'left'} }} > 
                    ...
                    <Typography sx={{ opacity: 0.7, fontWeight: 'light', textAlign: { xs: 'center', sm:'center', md: 'center', lg: 'left' } }} color={'grey'} variant='h5'>
                        <TypewriterComponent
                            options={{
                                strings: [
                                    ...
                                    '<strong>Databases and Data Management</strong>: MongoDB, Firebase, MySQL, PostgreSQL, Talend',
